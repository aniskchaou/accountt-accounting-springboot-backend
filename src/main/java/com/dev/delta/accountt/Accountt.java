...
import com.dev.delta.accountt.services.UserAccounttService;
...
public class Accountt implements IAcountt {
	...
	@Autowired
	UserAccounttService userService;
	...
	public void initUser() {
		userService.saveOrUpdate(new UserAccountt("admin", "admin", "admin", "admin"));
